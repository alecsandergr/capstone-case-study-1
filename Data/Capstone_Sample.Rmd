...
The data will be aggregated and saved to facilitate further analysis and also in the creation of graphs.
They will be divided into csv files, having a summary of the data as follows:
* By user
* By hour
* By day
* By month
